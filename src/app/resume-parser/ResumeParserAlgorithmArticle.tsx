  ...
  return (
    <article className="mt-10">
      <Heading className="text-primary !mt-0 border-t-2 pt-8">
        Resume Analyzer Algorithm Deep Dive
      </Heading>
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the OpenResume
        Analyser algorithm and walks through the 4 steps on how it works. (Note
      ...
      <Paragraph smallMarginTop={true}>
        ...
        file. Similarly, the resume Analyzer first needs to decode the PDF file in
      ...
      <Paragraph>
        ...
        library. In this case, the resume Analyzer uses Mozilla's open source{" "}
      ...
      <Paragraph smallMarginTop={true}>
        ...
        the resume Analyzer connects adjacent text items into one text item if
      ...
      <Paragraph smallMarginTop={true}>
        <span className="font-semibold">Solution:</span> To tackle this issue,
        the resume Analyzer reconstructs those contexts and associations similar
      ...
      <Paragraph>
        At the end of step 2, the resume Analyzer extracts {lines.length} lines
      ...
      <Paragraph smallMarginTop={true}>
        At step 2, the resume Analyzer starts building contexts and associations
      ...
      <Paragraph>
        ...
        not just in resumes but also in books and blogs. The resume Analyzer uses
        this pattern to group lines into the closest section title above these
        lines.
      </Paragraph>
      <Paragraph>
        The resume Analyzer applies some heuristics to detect a section title. The
      ...
      <Paragraph>
        The resume Analyzer also has a fallback heuristic if the main heuristic
      ...
      <Paragraph>
        At the end of step 3, the resume Analyzer identifies the sections from the
      ...
      <Paragraph smallMarginTop={true}>
        ...
        core of the resume Analyzer, where it extracts resume information from the
        sections.
      </Paragraph>
      ...
      <Paragraph smallMarginTop={true}>
        The resume Analyzer applies some heuristics to detect a subsection. The
      ...
      <Paragraph>
        And that is everything about the OpenResume Analyzer algorithm :)
      </Paragraph>
      <Paragraph>
